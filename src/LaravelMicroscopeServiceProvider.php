...
namespace codicastudio\LaravelMicroscope;
...
use codicastudio\LaravelMicroscope\Commands\CheckViews;
use codicastudio\LaravelMicroscope\ErrorReporters\ConsolePrinterInstaller;
use codicastudio\LaravelMicroscope\ErrorReporters\ErrorPrinter;
use codicastudio\LaravelMicroscope\SpyClasses\SpyBladeCompiler;
use codicastudio\LaravelMicroscope\SpyClasses\SpyDispatcher;
use codicastudio\LaravelMicroscope\SpyClasses\SpyFactory;
use codicastudio\LaravelMicroscope\SpyClasses\SpyGate;
use codicastudio\LaravelMicroscope\SpyClasses\SpyRouter;
use codicastudio\LaravelMicroscope\SpyClasses\ViewsData;
...
//        ($checkAll || Str::startsWith('check:events', $command)) && $this->spyEvents();
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/config.php', 'code-fix');
    }
