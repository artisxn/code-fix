...
namespace codicastudio\LaravelMicroscope\SpyClasses;
...
class SpyRouter extends Router
{
    ...
    /**
     * @var \codicastudio\LaravelMicroscope\SpyClasses\SpyRouteCollection
     */
    ...
    private function isExcluded($info)
    {
        return Str::startsWith(($info['file'] ?? ''), [
            ...
            base_path('vendor'.DIRECTORY_SEPARATOR.'codicastudio'),
        ]);
    }
